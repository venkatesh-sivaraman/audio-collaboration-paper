...
This result is consistent with prior studies \cite{ice,oomen,tu}, indicating that text played the most significant role in \emph{factual} comprehension, while audio was most useful for \emph{tonal} comprehension.
Therefore, we decided to maintain the combined paradigm throughout the remainder of the study.
