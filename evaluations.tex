...
Cohen's $\kappa$ between the two coders was .78, confirming that the categorized themes were reliable.
...
In addition to the simple transcript-related findings, the qualitative study also yielded the following new observations:
