...
\red{This design goal is hard to grasp. Let's make it clearer: to support versatile live voice production features with text-editing like interface.--this is written horribly at 4 am, but I believe that you will be able to rephrase it.}
...
\red{We followed an iterative procedure to increasingly improved the design of the SimpleSpeech interactions}.
...
(The prompts used in the tests were adapted from the GRE Pool of Issue Topics.) \red{pilot user demographic information here}
