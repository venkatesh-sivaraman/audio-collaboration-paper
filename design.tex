...
Our user interface is quite similar to those created by Rubin \cite{rubin}, Yoon \cite{yoon}, and Whittaker \cite{whittaker_semantic}, with only slight conceptual modifications to suit the ``live'' editing paradigm, so we do not discuss the redundant design details here.
