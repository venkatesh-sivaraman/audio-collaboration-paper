...
We introduce SimpleSpeech, an easy-to-use platform for asynchronous audio collaboration (AAC) based on automatically-generated speech transcripts.
...
When applied to contexts appropriate for this level of formality, such as learning at-scale, SimpleSpeech could serve the crucial purpose of lowering the barrier to participate in audio-based communication and improving engagement in these collaborative environments.
\end{abstract}
