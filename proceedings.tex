...
We introduce SimpleSpeech, an easy-to-use live audio production tool based on automatically-generated speech transcripts.
Asynchronous audio collaboration has the potential to improve engagement and productivity in online education and other discussion contexts, but the linearity of audio and the difficulty of editing tend to discourage collaborators from utilizing voice-based media.
SimpleSpeech addresses these concerns through lightweight transcript-based editing tools for deleting and inserting content and adjusting pauses in the audio.
Qualitative and quantitative results suggest that novice audio producers, such as high school students, experience greater success and decreased mental workload when using SimpleSpeech as compared to a
\end{abstract}
